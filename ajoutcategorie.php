...
<body>
    ...
    <div class="container shadow-lg p-3 mt-5 bg-body rounded">
        ...
        <form action="categorie.php" method="post" onsubmit="return validateForm()">
            <div class="row d-flex justify-content-around">
                <div class="mb-3 col-12 col-md-5 col-lg-5">
                    <label for="nomCategorie" class="form-label">Nom de la Catégorie</label>
                    <input name="nomCategorie" type="text" class="form-control" id="nomCategorie" aria-describedby="emailHelp">
                    <span class="error" id="nomCategorieError"></span>
                </div>
            </div>
    ...
    <script>
        function validateForm() {
            ...
            document.getElementById('nomCategorieError').textContent = '';
            ...
            if (nomCategorie === '') {
                document.getElementById('nomCategorieError').textContent = 'Le nom de la catégorie est obligatoire';
                document.getElementById('nomCategorie').classList.add('error-border');
                isValid = false;
            } else if (nomCategorie.length > 100) { 
                document.getElementById('nomCategorieError').textContent = 'Le nom de la catégorie ne doit pas dépasser 100 caractères';
                document.getElementById('nomCategorie').classList.add('error-border');
                isValid = false;
            }
