        ...
        <form action="" method="post">
            <div class="row d-flex justify-content-around">
                <div class="mb-3 col-12 col-md-5 col-lg-5">
                    <label for="idEmprunt" class="form-label">Emprunt</label>
                    <input name="idEmprunt" type="text" class="form-control" id="idEmprunt" aria-describedby="emailHelp">
                </div>
            </div>
            
            <div class="row d-flex justify-content-around">
                <button type="submit" name="valider" class="btn btn-primary button mt-4">RETOURNER</button>
            </div>
        </form> 
    </div>
</body>
